...
import finalforeach.cosmicreach.blocks.blockentities.BlockEntityItemContainer;
import sh.miles.voidcr.world.block.entity.BlockEntityCrate;
import sh.miles.voidcr.world.inventory.container.ItemContainer;

public class VoidBlockEntityCrate extends VoidBlockEntity<finalforeach.cosmicreach.blocks.blockentities.BlockEntityItemContainer> implements BlockEntityCrate {
